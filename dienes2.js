...
window.onload = function() {
    ...
    document.getElementById('.exercise').innerHTML = "hiiiiii" + randomNumber1 + "looooool" + randomNumber2 + " = " + "<button class=\"btn btn-info\" onClick=\"playSound()\"><i class=\"bi bi-volume-up\"></i></button>";
}
